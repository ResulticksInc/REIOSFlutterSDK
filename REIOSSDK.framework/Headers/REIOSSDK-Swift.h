...
SWIFT_PROTOCOL("_TtP8REIOSSDK25REiosFlutterSocketEnabled_")
@protocol REiosFlutterSocketEnabled
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, strong) id <REiosSmartLinkReceiver> _Nullable socketEnabled;)
+ (id <REiosSmartLinkReceiver> _Nullable)socketEnabled SWIFT_WARN_UNUSED_RESULT;
+ (void)setSocketEnabled:(id <REiosSmartLinkReceiver> _Nullable)value;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSArray * _Nonnull flutterData;)
+ (NSArray * _Nonnull)flutterData SWIFT_WARN_UNUSED_RESULT;
+ (void)setFlutterData:(NSArray * _Nonnull)value;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
